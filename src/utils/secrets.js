...
export const LDAP_USER_RDN = process.env['LDAP_USER_RDN'] || 'uid'
export const LDAP_USER_FILTER = process.env['LDAP_USER_FILTER'] || `(&(${LDAP_USER_RDN}={{username}})(objectclass=person))`
